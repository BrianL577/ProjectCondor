...
export function db() {
  ...
  // Trim defensively: pasted env vars in dashboards frequently carry a
  // trailing newline/space/quote, which breaks URL parsing deep inside
  // the Supabase client with an opaque "Invalid path specified in
  // request URL" error that gives no hint it's an env var problem.
