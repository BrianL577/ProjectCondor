...
export function db() {
  ...
  // The Supabase client library appends /rest/v1/... itself — if the env
  // var was set to the "API URL" (which already has /rest/v1 on the end,
  // as shown in some Supabase dashboard panels) instead of the bare
  // "Project URL", every request doubles up to /rest/v1/rest/v1/... and
  // silently hits the wrong route. Strip that suffix defensively.
